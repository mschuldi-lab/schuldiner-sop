...
* After you take your pads out from the Singer’s dirty pads’ drawer, replace the paper lining with new paper (paper disposer is hanging on the wall next to the Singer).


:::danger
- Do not recycle Singer plates if they are highly contaminated and the fungus touches the plate itself and/or the contamination is “fluffy” (these are spores that will disperse in the lab the minute you open the plate) - throw them to the biohazard bin.
:::
...
* After touching dirty pads and before continuing using the Singer – change gloves.

* Make sure to label the plates beforehand to avoid confusion. If using stickers – print stickers before.
